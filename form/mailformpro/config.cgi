...
## フォームの送信先
push @mailto,'thuta@cyberwings.asia';
#push @mailto,'admin@bingo-group.co.jp';
#push @mailto,'k-hashihama@syncrise.co.jp';
#push @mailto,'k-hashida@syncrise.co.jp';

## 自動返信メールの差出人名
$config{'fromname'} = 'IBB株式会社';
...
## 設置者に届くメールの件名
$config{'subject'} = '[ %s ] プライベートエンジンオイルLPお問い合せフォームから';

## 設置者に届くメールの本文整形
$_TEXT{'posted'} = <<'__posted_body__';
<_mfp_date_>
プライベートエンジンオイルLP
お問い合せフォームより以下のメールを受け付けました。
──────────────────────────
受付番号：<_mfp_serial_>
